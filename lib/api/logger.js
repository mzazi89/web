  ...
  try {
    await sql`
      INSERT INTO api_requests
        (request_id, user_id, api_key_id, endpoint, method, status_code, response_time_ms, provider, ip, user_agent, error_code)
      VALUES
        (${requestId}, ${userId}, ${apiKeyId}, ${endpoint}, ${method}, ${statusCode}, ${Math.round(responseTimeMs)}, ${provider}, ${ip}, ${userAgent}, ${errorCode})
    `;
