...
// The live provider returns { success: true, data: "…" } — `data` holds the
// answer for the /ai/* family (verified 2026-08-30). Other keys kept for
// older/different variants.
export function normalizeAI(payload) {
  ...
  if (payload && typeof payload === 'object') {
    ...
    const answer = pick(payload, ['data', 'response', 'reply', 'text', 'message', 'answer', 'content'], null);
