    ...
    <div className="min-h-screen" style={{ backgroundColor: '#060810' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-wrap gap-2 mb-8">
          {[{ href: '/admin/dashboard', label: 'Overview' }, { href: '/admin/users', label: 'Users' }, { href: '/admin/transactions', label: 'Transactions' }, { href: '/admin/inquiries', label: 'Inquiries', active: true }, { href: '/admin/packages', label: 'Packages' }].map(n => (
